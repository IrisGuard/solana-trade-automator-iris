...
// Try default import approach to fix the createClient import issue
...
// Create Supabase client with proper configuration using default import
export const supabase = supabase_js.createClient<Database>(supabaseUrl, supabaseAnonKey, {
  auth: {
    persistSession: true,

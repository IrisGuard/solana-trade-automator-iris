        ...
        <div className="flex flex-col lg:flex-row gap-8 relative">
          ...
          {steps.map((step, index) => (
            <div key={index} className="flex-1 relative z-10">
              {/* Step indicator */}
              <div className={`w-16 h-16 rounded-full bg-gradient-to-br ${getGradient(step.color)} flex items-center justify-center text-2xl font-bold mx-auto mb-8 shadow-lg shadow-${step.color}-600/30`}>
              ...
              <div className={`bg-gradient-to-br ${getGradient(step.color)} p-0.5 rounded-xl shadow-lg shadow-${step.color}-600/20 h-full`}>
                <div className="bg-gray-900 rounded-lg p-6 h-full">
                  <div className={`w-16 h-16 rounded-full bg-gradient-to-br ${getGradient(step.color)}/20 flex items-center justify-center mb-4`}>
                    {step.icon}
                  </div>
